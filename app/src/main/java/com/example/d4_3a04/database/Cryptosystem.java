...
//                mysqlConnection = DriverManager.getConnection("jdbc:mysql://10.0.2.2:3306/testdb?useUnicode=true&characterEncoding=UTF-8", "root", "PNJMR");
                ...
                mysqlConnection = DriverManager.getConnection("jdbc:mysql://roundhouse.proxy.rlwy.net:15416/railway?", "root", "vXkxjSryhPjEvhRLZoJSyIDZgJzLXJUU");
            }catch (Exception e){
